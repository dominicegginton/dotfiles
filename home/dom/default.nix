  ...
  config = {
    ...
    modules.display = {
      ...
      plasma.shortcuts = {
        ...
        "ksmserver"."Log Out" = "none,Ctrl+Alt+Del,Log Out";
      ...
      plasma.configFile = {
        ...
        "kdeglobals"."General"."AccentColor" = "108,142,217";
        ...
        "kwalletrc"."Auto Allow"."kdewallet" = "KDE System,discord";
        ...
        "kwinrc"."TabBox"."MinimizedMode" = 2;
        "kwinrc"."TabBox"."MultiScreenMode" = 2;
