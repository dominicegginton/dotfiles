...
pkg.overrideAttrs (_: {
  passthru = {
    ...
    sbomnix = writeShellScriptBin "sbomnix" ''
    ...
    nixgraph = writeShellScriptBin "nixgraph" ''
    ...
    provenance = writeShellScriptBin "provenance" ''
    ...
    vulnxscan = writeShellScriptBin "vulnxscan" ''
