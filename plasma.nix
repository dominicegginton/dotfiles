{
  programs.plasma = {
    ...
    configFile = {
      ...
      "katerc"."filetree"."editShade" = "217,214,134";
      ...
      "kcminputrc"."Libinput/1/1/solaar-keyboard"."Enabled" = false;
      "kcminputrc"."Libinput/1133/16514/Logitech MX Master 3"."LeftHanded" = false;
      "kcminputrc"."Libinput/1133/16514/Logitech MX Master 3"."PointerAccelerationProfile" = 2;
      "kcminputrc"."Libinput/1386/18496/Wacom HID 4840 Finger"."Enabled" = true;
      "kcminputrc"."Libinput/1452/592/Keychron Keychron K2"."Enabled" = true;
      ...
      "ktrashrc"."\\/home\\/dom\\/.local\\/share\\/Trash"."Days" = 7;
      "ktrashrc"."\\/home\\/dom\\/.local\\/share\\/Trash"."LimitReachedAction" = 0;
      "ktrashrc"."\\/home\\/dom\\/.local\\/share\\/Trash"."Percent" = 10;
      "ktrashrc"."\\/home\\/dom\\/.local\\/share\\/Trash"."UseSizeLimit" = true;
      "ktrashrc"."\\/home\\/dom\\/.local\\/share\\/Trash"."UseTimeLimit" = false;
      ...
      "spectaclerc"."ImageSave"."lastImageSaveAsLocation" = "file:///home/dom/Pictures/Screenshots/Screenshot_20240906_141127.png";
      "spectaclerc"."ImageSave"."lastImageSaveLocation" = "file:///home/dom/Pictures/Screenshots/Screenshot_20240906_141127.png";
      "spectaclerc"."ImageSave"."translatedScreenshotsFolder" = "Screenshots";
      "spectaclerc"."VideoSave"."translatedScreencastsFolder" = "Screencasts";
    };
    dataFile = {
      "dolphin/view_properties/global/.directory"."Dolphin"."HeaderColumnWidths" = "390,72,127,72,150,127,72,106";
      "dolphin/view_properties/global/.directory"."Dolphin"."ViewMode" = 1;
      "dolphin/view_properties/global/.directory"."Dolphin"."VisibleRoles" = "CustomizedDetails,Details_text,Details_size,Details_modificationtime,Details_creationtime,Details_type,Details_accesstime,Details_tags,Details_permissions";
      "dolphin/view_properties/global/.directory"."Settings"."HiddenFilesShown" = true;
      "kate/anonymous.katesession"."Document 0"."URL" = "file:///home/dom/Downloads/map";
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-H-Splitter" = "0,1529,0";
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-0-Splitter" = 509;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-1-Splitter" = 509;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-2-Splitter" = 1529;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-3-Splitter" = 1306;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-V-Splitter" = "0,507,0";
      ...
      "kate/anonymous.katesession"."MainWindow0-Splitter 0"."Sizes" = 1529;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."Active View" = "file:///home/dom/Downloads/map";
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."Count" = 1;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."Documents" = "file:///home/dom/Downloads/map";
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."View 0" = "file:///home/dom/Downloads/map";
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/dom\\/Downloads\\/map"."ScrollLine" = 78;
