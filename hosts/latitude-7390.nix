...

{
  ...
  boot.kernel.sysctl = {
    ...
    # enhance security by preventing kernel replacement.
    ...
    "kernel.hz" = 1000;
    # split lock mitigate can slow down performance
    # when processing workloads that require frequent
    # access to unaligned memory operations
