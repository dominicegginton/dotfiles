        ...
        [
          ...
          (
            let
              ...
              uuid = "dynamic-music-pill@andbal23";
              name = "Dynamic Music Pill";
              pname = "dynamic-music-pill";
              description = "A Gnome Shell extension that adds a music pill to the top bar, showing the currently playing song and allowing you to control playback. It supports various music players and streaming services, providing a convenient way to manage your music without opening the player.";
              version = 14;
